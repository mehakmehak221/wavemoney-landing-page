    ...
    <section className='relative w-full pt-12 md:pt-16 lg:pt-28 pb-24 md:pb-32 lg:pb-56 overflow-hidden min-h-[500px] md:min-h-[600px]' id='worldwide'>
      ...
      <div className='relative z-10 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto'>
          ...
          <div className='bg-[#E3ECD9]/50 backdrop-blur-sm  shadow-xl p-6 sm:p-20 flex flex-col items-center text-center transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 border-[#546E3A66] border'>
